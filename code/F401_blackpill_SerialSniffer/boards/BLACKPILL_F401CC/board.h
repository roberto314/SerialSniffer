...
/*
 * Setup for STM32 Blackpill-F411CE board.
 */

/*
 * Board identifier.
 */
#define BOARD_BLCKPILL_F401CE
#define BOARD_NAME                  "STM32 Blackpill-F401CE"
 ...
 * PA4  - ARD_A2 ADC1_IN4           (output pushpull maximum).
 * PA5  - LED_GREEN ARD_D13         (alternate 5).
 * PA6  - ARD_D12                   (alternate 5).
 * PA7  - ARD_D11                   (alternate 5).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_ARD_A0) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_ARD_A2) |        \
                                     PIN_MODE_ALTERNATE(GPIOA_LED_GREEN) |  \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_ARD_A0) |     \
                                     ...
                                     PIN_OTYPE_OPENDRAIN(GPIOA_ARD_D7) |    \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_ARD_A0, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOA_LED_GREEN, 5U) |     \
                                     PIN_AFIO_AF(GPIOA_ARD_D12, 5U) |       \
                                     PIN_AFIO_AF(GPIOA_ARD_D11, 5U))
